...
export default function Footer() {
  return (
    <div className='border-top' style={{backgroundColor:"rgb(251,251,251)"}}>
      <div className='container p-5 footer'>
          <div className="row px-5">
              <div className="col">
                <img src="images/logo.svg" style={{width:"70%"}} alt="zerodha-logo"  className='mb-4 mt-2'/>
                  <p className=" text-muted" style={{fontSize:"0.7rem"}}>© 2010 - 2026, Zerodha Broking Ltd. <br />
          ...
          <div className="para mt-5 px-5 text-muted" style={{fontSize:"0.7rem"}}>
